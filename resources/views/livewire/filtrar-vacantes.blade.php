  ...
  <div class="max-w-7xl mx-auto">
    <form wire:submit.prevent='leerDatosFormulario'>
      <div class="md:grid md:grid-cols-3 gap-5">
        <div class="mb-5">
          <label class="block mb-1 text-sm text-gray-700 uppercase font-bold" for="termino">Término de búsqueda</label>
          <input id="termino" type="text" placeholder="Buscar por término: ej. Laravel." class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full" wire:model="termino"/>
        </div>
        <div class="mb-5">
        ...
        <div class="mb-5">
          ...
          <select wire:model="salario" class="border-gray-300 p-2 w-full">
            <option>-- Seleccione el salario mensual --</option>
